...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(632);
...
// EXTERNAL MODULE: external "/home/borja/Proyectos/hznteam.github.io/node_modules/react/index.js"
var index_js_ = __webpack_require__(632);
...
// EXTERNAL MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog/src/components/layout.tsx + 17 modules
...
/* harmony default export */ const github = (github_theme);
...
const ColorModeToggle=({isDark,toggle})=>(0,theme_ui_esm/* jsx */.tZ)("button",{onClick:toggle,type:"button","aria-label":isDark?`Activate Light Mode`:`Activate Dark Mode`,title:isDark?`Activate Light Mode`:`Activate Dark Mode`,sx:{opacity:0.65,position:`relative`,borderRadius:`4px`,width:`40px`,height:`25px`,display:`flex`,alignItems:`center`,justifyContent:`center`,transition:`opacity 0.3s ease`,border:`none`,outline:`none`,background:`none`,cursor:`pointer`,padding:0,appearance:`none`,"&:hover, &:focus":{opacity:1}}},(0,theme_ui_esm/* jsx */.tZ)("div",{sx:{position:`relative`,width:`24px`,height:`24px`,borderRadius:`50%`,border:t=>isDark?`4px solid ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}`:`none`,backgroundColor:isDark?`toggleIcon`:`transparent`,transform:isDark?`scale(0.55)`:`scale(1)`,transition:`all 0.45s ease`,overflow:isDark?`visible`:`hidden`,boxShadow:t=>isDark?`none`:`inset 8px -8px 0px 0px ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}`,"&:before":{content:`""`,position:`absolute`,right:`-9px`,top:`-9px`,height:`24px`,width:`24px`,border:t=>isDark?`2px solid ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}`:`none`,borderRadius:`50%`,transform:isDark?`translate(14px, -14px)`:`translate(0, 0)`,opacity:isDark?0:1,transition:`transform 0.45s ease`},"&:after":{content:`""`,width:`8px`,height:`8px`,borderRadius:`50%`,margin:`-4px 0 0 -4px`,position:`absolute`,top:`50%`,left:`50%`,boxShadow:t=>`0 -23px 0 ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}, 0 23px 0 ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}, 23px 0 0 ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}, -23px 0 0 ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}, 15px 15px 0 ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}, -15px 15px 0 ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}, 15px -15px 0 ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}, -15px -15px 0 ${(0,theme_ui_css_esm/* get */.U2)(t,`colors.toggleIcon`)}`,transform:isDark?`scale(1)`:`scale(0)`,transition:`all 0.35s ease`}}}));/* harmony default export */ const colormode_toggle = (ColorModeToggle);
...
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(1151);
;// CONCATENATED MODULE: ./content/posts/nuestro-cms/index.mdx
/*@jsxRuntime classic @jsx React.createElement @jsxFrag React.Fragment*/function _createMdxContent(props){const _components=Object.assign({h2:"h2",h3:"h3",p:"p",strong:"strong"},(0,lib/* useMDXComponents */.ah)(),props.components);return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(_components.h2,null,"Core: Nuestro propio CMS automátio alimentado con Inteligencia Artificial para crear nichos"),"\n",/*#__PURE__*/index_js_default().createElement(_components.h3,null,"¿Qué es un CMS?"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Un sistema de gestión de contenidos (CMS, por sus siglas en inglés, Content Management System) es una aplicación web que permite la creación, edición y publicación de contenido de manera sencilla y rápida. Los CMS son muy útiles para gestionar sitios web."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Nuestro CMS cuenta con una interfaz de usuario amigable y fácil de usar, que nos permite realizar el mantenimiento del contenido generado por la IA de manera intuitiva."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h3,null,"¿Qué quiere decir CMS automático?"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"En la actualidad tardamos entre 10 y 15 minutos en montar toda una web desde cero, con al menos 50 publicaciones. Nuestro CMS es único y exclusivo y está enfocado 100% en cumplir con las estructuras y recomedaciones SEO."),"\n",/*#__PURE__*/index_js_default().createElement(_components.h3,null,"¿Cual es nuestro objetivo?"),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"En estos momentos, nos encontramos mejorando el CMS día a día, y estamos poniendolo a prueba para quizás en un futuro ofrecer un servicio de montaje de nichos web."),"\n",/*#__PURE__*/index_js_default().createElement(_components.p,null,"Si quieres tener más información sobre nuestro CMS, ",/*#__PURE__*/index_js_default().createElement(_components.strong,null,"no dejes de visitarnos"),", os mantendremos informad@s con nuevos avances y datos. :)"));}function MDXContent(props={}){const{wrapper:MDXLayout}=Object.assign({},(0,lib/* useMDXComponents */.ah)(),props.components);return MDXLayout?/*#__PURE__*/index_js_default().createElement(MDXLayout,props,/*#__PURE__*/index_js_default().createElement(_createMdxContent,props)):_createMdxContent(props);}/* harmony default export */ const nuestro_cms = (MDXContent);
...
;// CONCATENATED MODULE: ./node_modules/@lekoarts/gatsby-theme-minimal-blog-core/src/templates/post-query.tsx?__contentFilePath=/home/borja/Proyectos/hznteam.github.io/content/posts/nuestro-cms/index.mdx



post/* default */.Z;
function GatsbyMDXWrapper(props) {
  return /*#__PURE__*/index_js_default().createElement(post/* default */.Z, props, /*#__PURE__*/index_js_default().createElement(nuestro_cms, props));
}
...
;
//# sourceMappingURL=component---node-modules-lekoarts-gatsby-theme-minimal-blog-core-src-templates-post-query-tsx-content-file-path-home-borja-proyectos-hznteam-github-io-content-posts-nuestro-cms-index-mdx.js.map